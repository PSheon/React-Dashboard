...
function FollowTradeBotsBoardPage(props) {
	...
	return (
		<div className="w-full">
			<FuseAnimate animation="transition.slideUpIn" delay={200}>
				<Breadcrumbs breadCrumbTitle="策略跟投" breadCrumbs={[{ title: '我的跟投', isActive: true }]} />
			</FuseAnimate>
			...
			>
				<div className="w-full sm:w-1/4 p-16">
					<WidgetBasicCard title="跟投數量" content="2" iconType="activity" iconColorSchema="primary" />
				</div>
				<div className="w-full sm:w-1/4 p-16">
...
export default FollowTradeBotsBoardPage;
