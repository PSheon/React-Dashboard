...
function WidgetAnnouncementSettingCard(props) {
	...
	return (
		<Card className={clsx(classes.root, 'w-full rounded-8 shadow-none')}>
			<div className="px-24 pt-20 sm:pt-16 flex justify-between items-center">
				<Typography className="h1 font-medium">公告設定</Typography>
				<Tooltip
					arrow
					title="公告設定"
					placement="top"
...
export default React.memo(WidgetAnnouncementSettingCard);
