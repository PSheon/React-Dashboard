...
const WidgetCommodityBasicCard = ({ title, content, iconType, iconColorSchema }) => {
...
WidgetCommodityBasicCard.propTypes = {
...
WidgetCommodityBasicCard.defaultProps = {
	title: 'Title',
	content: 'Content',
	iconType: 'users',
...
export default WidgetCommodityBasicCard;
